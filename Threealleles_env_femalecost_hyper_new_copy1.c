                        ...
                        if(rnd4<0.5){
                            ...
                            if(rnd5<0.5){//次世代がオスの場合
                                ...
                                do
                                {
                                    ...
                                    // printf("genotype OK");
                                    if (maleP0 == 1)break;
                                    else if (maleP0 == 2&&rnd2 < V)continue;
                                    else if (maleP0 == 3&&rnd3 < K)continue;
                                    break;  
                            ...
                            if(rnd5<0.5){//次世代がオス
                                     ...
                                     do
							    {
                                    ...
                                    // printf("genotype OK");
                                    if (femaleT0==1)break;
                                    else if(femaleT0==2 && rnd2<l)continue;
                                    else if(femaleT0==3 && rnd3<u)continue;
                                    break;
                                } while (1);
                                }
